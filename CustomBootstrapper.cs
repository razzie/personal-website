...
public class CustomBootstrapper : DefaultNancyBootstrapper
{
    ...
    protected override void ConfigureConventions(NancyConventions nancyConventions)
    {
        ...
        nancyConventions.StaticContentsConventions.Add(StaticResourceConventionBuilder.AddDirectory("/js", assembly, "razweb.Scripts"));
        nancyConventions.StaticContentsConventions.Add(StaticResourceConventionBuilder.AddDirectory("/res", assembly, "razweb.Content"));
    }
